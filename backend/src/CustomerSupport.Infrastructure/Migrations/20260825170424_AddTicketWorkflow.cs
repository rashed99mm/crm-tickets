        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerAttachments_Assets_AssetId",
                        column: x => x.AssetId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerNotes_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromValue = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ToValue = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerAttachments_Customer",
                table: "CustomerAttachments",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "UX_CustomerAttachments_Asset",
                table: "CustomerAttachments",
                column: "AssetId",
                unique: true,
                filter: "[IsDeleted] = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerNotes_Customer_Created",
                table: "CustomerNotes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketHistory_Ticket_Occurred",
                table: "TicketHistory",
